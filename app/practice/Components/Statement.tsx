  ...
  return (
    ...
    >
      <div
        ...
        className="flex flex-row shadow-sm"
      >
        <div
          style={{ backgroundColor: "var(--background-primary)" }}
          className="p-3 tab"
        ...
        <div className="p-3 tab">Solution</div>
      </div>
      <div className="p-3 leading-8 h-full overflow-auto">
        ...
        <div className="text-sm leading-7">
          ...
          <p className="mt-4">
            A subsequence of an array is a set of numbers that arent necessarily
            adjacent in the array but that are in the same order as they appear
            in the array. For instance, the numbers <span>[1, 3, 4]</span> form
            a subsequence of the array
            <span>[1, 2, 3, 4]</span>, and so do the numbers <span>[2, 4]</span>
            . Note that a single number in an array and the array itself are
        ...
        <div
          style={{
            backgroundColor: "var(--background-title)",
            borderRadius: "10px",
          }}
          className=" w-full h-fit shadow-sm mt-4 overflow-auto testcase-container"
        >
          <CodeMirror
