  ...
  return (
    ...
    >
      <div
        ...
        className="flex flex-row shadow-sm text-md"
      >
        <div
          style={{ backgroundColor: "var(--background-primary)" }}
          className=" p-3 tab"
      ...
      <div className=" w-full h-full max-h-fit">
        <div
          ...
          className="p-3 leading-9 w-full h-full overflow-auto max-h-max flex flex-col gap-4 testcase-container"
        >
            ...
            return (
              <React.Fragment key={idx}>
                ...
                <div
                  ...
                  className=" w-full h-fit shadow-sm"
                >
                  <CodeMirror
